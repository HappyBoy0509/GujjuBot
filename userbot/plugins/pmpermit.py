...
USER_BOT_WARN_ZERO = "`You were spamming HappyBoy's inbox.` "
USER_BOT_NO_WARN = ("[──▄█▀█▄─────────██ \n▄████████▄───▄▀█▄▄▄▄ \n██▀▼▼▼▼▼─▄▀──█▄▄ \n█████▄▲▲▲─▄▄▄▀───▀▄ \n██████▀▀▀▀─▀────────▀▀](tg://user?id=948408212)\n\n"
                    "`Hello, This is Protected Security Service,`"
                    f"Don't Spam {DEFAULTUSER}`'s inbox.\n\n"
                    "Hopefully you'll get a reply within 2 light years.`\n\n"
