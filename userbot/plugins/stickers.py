...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "@HappyBoy59"
...
async def _(event):
    ...
    if is_a_s:
        ...
        packname = f"@happyboy59 2"
        if userid == 948408212:
            packshortname = "Jayu_Animated"
        else:
            packshortname = f"happyboy0509" # format: Uni_Borg_userid
